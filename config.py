...
FINAL_SUMMARY_MAX_UNITS = _env_int("FINAL_SUMMARY_MAX_UNITS", 70)
FINAL_CONTENT_MAX_UNITS = _env_int("FINAL_CONTENT_MAX_UNITS", 0)
...
XIUMI_IMAGE_UPLOAD_WAIT_SECONDS = _env_int("XIUMI_IMAGE_UPLOAD_WAIT_SECONDS", 8)
XIUMI_FIRST_IMAGE_UPLOAD_WAIT_SECONDS = _env_int("XIUMI_FIRST_IMAGE_UPLOAD_WAIT_SECONDS", 20)
XIUMI_IMAGE_UPLOAD_MAX_FAILURES = _env_int("XIUMI_IMAGE_UPLOAD_MAX_FAILURES", 3)
XIUMI_IMAGE_UPLOAD_RETRIES = _env_int("XIUMI_IMAGE_UPLOAD_RETRIES", 1)
